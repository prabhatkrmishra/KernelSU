...
void susfs_try_umount_all(uid_t uid) {
	...
	ksu_try_umount("/system", true, 0, MNT_DETACH);
	ksu_try_umount("/system_ext", true, 0, MNT_DETACH);
	ksu_try_umount("/vendor", true, 0, MNT_DETACH);
	ksu_try_umount("/product", true, 0, MNT_DETACH);
	ksu_try_umount("/odm", true, 0, MNT_DETACH);
